...
def main():
    ap=argparse.ArgumentParser(); ap.add_argument("--root",default="."); ap.add_argument("--out",default="sbom.json"); args=ap.parse_args()
    ...
    if "package.json" in proj:
        ...
        except (json.JSONDecodeError, FileNotFoundError): sbom["manifests"]["package.json"]={"error":"parse_error"}
